...
use rom_weaver_app::{
    ...
    IdentifyTitleSearchMatch, IdentifyTitleSearchResult, IngestCommand, IngestKind, IngestResult,
...
fn render_types() -> String {
    ...
    let mut declarations = vec![
        ...
        export_decl::<IdentifyTitleSearchMatch>(&config),
        export_decl::<IdentifyTitleSearchResult>(&config),

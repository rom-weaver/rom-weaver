...
use rom_weaver_app::{
    ...
    CompressionLevelProfile, ExportCommand, ExportOptions, ExtractCommand, ExtractStepDetails,
    ExtractedFileEntry, FilterKind, IngestCommand, IngestKind, IngestResult, IngestRomAsset,
    LogLevel, N64ByteOrder, OutputEnforceableEntry, PatchApplyCommand, PatchApplyHeaderMode,
...
fn render_types() -> String {
    ...
    let mut declarations = vec![
        ...
        export_decl::<ExportOptions>(&config),
        export_decl::<ExportCommand>(&config),

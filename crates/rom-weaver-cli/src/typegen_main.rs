...
use rom_weaver_app::{
    BundleCheatEntry, BundleChecks, BundleCommands, BundleCreateCommand, BundleCreateResult,
    BundleOutput, BundleParseCommand, BundleParseResult, BundlePatchEntry, BundlePatchSource,
    BundleRom, BundleSourceKind, BundleSourceRef, CheatCommand, CheatCommandResult, CheatKind,
    CheatRecord, CheatResolution, CheatSystem, CheatTarget, CheatWrite, CheatWriteConflict,
    ChecksumCommand, ClassifiedCheatRecord, Commands, CompressCommand, CompressionLevelProfile,
    ExtractCommand, ExtractStepDetails, ExtractedFileEntry, FilterKind, IdentifyCommand,
    IdentifyComponent, IdentifyDatabaseCommands, IdentifyDatabaseDirCommand,
    IdentifyDatabaseGroupCommand, IdentifyDatabaseImportCommand, IdentifyDatabaseInfo,
    IdentifyDatabaseInstallCommand, IdentifyDatabaseSystemCommand, IdentifyDatabaseUpdateCommand,
    IdentifyEvidence, IdentifyLookupResult, IdentifyMedia, IdentifyProvenance, IdentifyResult,
    IdentifyStatus, IdentifySubcommands, IdentifyTitleMatch, IngestCommand, IngestKind,
    IngestResult, IngestRomAsset, LogLevel, N64ByteOrder, OutputEnforceableEntry,
    ...
    ProbeCommand, RomWeaverBundle, RomWeaverRunOutputOptions, RomWeaverRunRequest, SaveCommands,
    SaveExportSchemaCommand, SaveGetCommand, SaveIdentifyCommand, SaveInspectCommand,
    SaveSetCommand, ToolsCommands, TrimCommand, compression_metadata,
...
use rom_weaver_core::{
    ...
    ROM_FILTER_FILE_EXTENSIONS, RomWeaverErrorKind, SaveChangePreview, SaveConstraint,
    SaveDocument, SaveEdit, SaveEditResult, SaveField, SaveFieldChange, SaveFieldKind,
    SaveGameCandidate, SaveGameDefinition, SaveGameIdentity, SaveIntegrity, SaveIntegrityIssue,
    SaveIntegrityState, SaveRecognition, SaveRecognitionConfidence, SaveRecognitionOutcome,
    SaveRecognitionReason, SaveSection, SaveValue, ThreadBudget, ThreadExecution, ThreadMode,
};
...
fn render_types() -> String {
    ...
    let mut declarations = vec![
        ...
        export_decl::<CheatSystem>(&config),
        export_decl::<CheatKind>(&config),
        ...
        export_decl::<CheatCommandResult>(&config),
        ...
        export_decl::<IdentifyStatus>(&config),
        export_decl::<IdentifyTitleMatch>(&config),
        export_decl::<IdentifyProvenance>(&config),
        export_decl::<IdentifyLookupResult>(&config),
        export_decl::<rom_weaver_core::MediaKind>(&config),
        export_decl::<rom_weaver_core::ComponentRole>(&config),
        export_decl::<rom_weaver_core::DetectionConfidence>(&config),
        export_decl::<rom_weaver_core::DetectionEvidence>(&config),
        export_decl::<rom_weaver_core::PlatformCandidate>(&config),
        export_decl::<IdentifyMedia>(&config),
        export_decl::<IdentifyComponent>(&config),
        export_decl::<IdentifyDatabaseInfo>(&config),
        export_decl::<IdentifyEvidence>(&config),
        export_decl::<IdentifyResult>(&config),
        export_decl::<IdentifyDatabaseDirCommand>(&config),
        export_decl::<IdentifyDatabaseSystemCommand>(&config),
        export_decl::<IdentifyDatabaseGroupCommand>(&config),
        export_decl::<IdentifyDatabaseImportCommand>(&config),
        export_decl::<IdentifyDatabaseInstallCommand>(&config),
        export_decl::<IdentifyDatabaseUpdateCommand>(&config),
        export_decl::<IdentifyDatabaseCommands>(&config),
        export_decl::<IdentifySubcommands>(&config),
        export_decl::<IdentifyCommand>(&config),
        ...
        export_decl::<SaveGameIdentity>(&config),
        export_decl::<SaveGameDefinition>(&config),
        export_decl::<SaveRecognitionConfidence>(&config),
        export_decl::<SaveRecognitionReason>(&config),
        export_decl::<SaveGameCandidate>(&config),
        export_decl::<SaveRecognitionOutcome>(&config),
        export_decl::<SaveRecognition>(&config),
        export_decl::<SaveIntegrityState>(&config),
        export_decl::<SaveIntegrityIssue>(&config),
        export_decl::<SaveIntegrity>(&config),
        export_decl::<SaveSection>(&config),
        export_decl::<SaveValue>(&config),
        export_decl::<SaveFieldKind>(&config),
        export_decl::<SaveConstraint>(&config),
        export_decl::<SaveField>(&config),
        export_decl::<SaveDocument>(&config),
        export_decl::<SaveFieldChange>(&config),
        export_decl::<SaveEdit>(&config),
        ...
        export_decl::<SaveExportSchemaCommand>(&config),
        export_decl::<SaveCommands>(&config),

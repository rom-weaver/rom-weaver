// Keep upstream nod's current control-flow style while the surrounding crate
// enforces its stricter workspace lint policy.
#![allow(
...
//!
//! ```no_run
//! use rom_weaver_containers::nod::read::{DiscOptions, DiscReader, PartitionEncryption};
//!
...
//! rom_weaver_containers::nod::util::buf_copy(&mut disc, &mut out).expect("Failed to write data");
//! ```
//!

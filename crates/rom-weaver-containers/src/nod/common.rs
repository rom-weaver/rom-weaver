...
impl Format {
    ...
    pub fn default_block_size(self) -> u32 {
        match self {
            Format::Ciso => crate::nod::io::ciso::DEFAULT_BLOCK_SIZE,
            #[cfg(feature = "compress-zlib")]
            Format::Gcz => crate::nod::io::gcz::DEFAULT_BLOCK_SIZE,
            Format::Rvz => crate::nod::io::wia::RVZ_DEFAULT_CHUNK_SIZE,
            Format::Wbfs => crate::nod::io::wbfs::DEFAULT_BLOCK_SIZE,
            Format::Wia => crate::nod::io::wia::WIA_DEFAULT_CHUNK_SIZE,
            _ => 0,
        }
    }
    ...
    pub fn default_compression(self) -> Compression {
        match self {
            #[cfg(feature = "compress-zlib")]
            Format::Gcz => crate::nod::io::gcz::DEFAULT_COMPRESSION,
            Format::Rvz => crate::nod::io::wia::RVZ_DEFAULT_COMPRESSION,
            Format::Wia => crate::nod::io::wia::WIA_DEFAULT_COMPRESSION,
            _ => Compression::None,
        }
    }
}

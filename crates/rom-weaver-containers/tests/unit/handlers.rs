...
mod tests {
    ...
    use crate::{
        ...
        lzma2_preset_dict_bytes, lzma2_threads_for_budget, zstd_threads_for_budget,
    };
    use chd::{
        header::Header,
    ...
    fn seven_z_runtime_threads_match_capabilities_for_create_and_extract() {
        run_with_large_stack("seven-z-thread-parity", || {
            ...
            // A single-file archive above the MT floor pipelines decode against
            // the write/hash consumer, so it plans exactly two threads.

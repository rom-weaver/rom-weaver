...
| 7z | 7zz 26.02 | −42.8% to +26.5% | −60.8% to +40.0% | +0.16% to +9.24% |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| GBA ROM `.gba` | 16 MB | 1.204 s ± 0.006 | 0.951 s ± 0.002 | +0.253 s (+26.5%) | 5.5 MB | 5.5 MB | +0.16% |
| GBA ROM (romhack) `.gba` | 32 MB | 1.868 s ± 0.052 | 2.049 s ± 0.010 | −0.181 s (−8.8%) | 9.7 MB | 9.7 MB | +0.19% |
| DS ROM `.nds` | 256 MB | 5.211 s ± 0.011 | 9.107 s ± 0.030 | −3.896 s (−42.8%) | 66.6 MB | 61.0 MB | +9.24% |
| 3DS ROM `.cci` | 1 GiB | 17.266 s ± 0.121 | 14.597 s ± 0.018 | +2.669 s (+18.3%) | 333.7 MB | 315.5 MB | +5.75% |

#### Extract

| Input | Input size | rom-weaver | 7zz | Time change | Output |
| --- | --- | --- | --- | --- | --- |
| GameCube A `.7z` | 77 MB | 3.375 s ± 0.073 | 2.506 s ± 0.018 | +0.869 s (+34.7%) | 227.4 MB |
| PS1 CD A `.7z` (8 tracks) | 287 MB | 4.130 s ± 0.025 | 10.549 s ± 1.108 | −6.419 s (−60.8%) | 515.4 MB |
| 3DS ROM `.7z` | 297 MB | 13.028 s ± 0.336 | 9.305 s ± 0.038 | +3.724 s (+40.0%) | 1,024.0 MB |
| PS1 CD C `.7z` | 459 MB | 17.635 s ± 0.208 | 13.482 s ± 0.175 | +4.153 s (+30.8%) | 657.2 MB |
| GD-ROM B `.7z` | 673 MB | 27.317 s ± 0.098 | 20.370 s ± 0.232 | +6.947 s (+34.1%) | 1,134.7 MB |

...
<picture>
  ...
  <img src="../screenshots/apply-patches-desktop-light.webp" width="2242" height="1045" style="height: auto" loading="eager" decoding="sync" alt="Focused Apply patch stack with two ordered practice patches on desktop">
</picture>
...
<picture>
  ...
  <img src="../screenshots/apply-output-desktop-light.webp" width="2242" height="560" style="height: auto" loading="eager" decoding="sync" alt="Focused Apply output card on desktop">
</picture>
...
<picture>
  ...
  <img src="../screenshots/create-inputs-desktop-light.webp" width="2242" height="837" style="height: auto" loading="eager" decoding="sync" alt="Focused Create Original and Modified cards on desktop">
</picture>
...
<picture>
  ...
  <img src="../screenshots/create-output-desktop-light.webp" width="2242" height="568" style="height: auto" loading="eager" decoding="sync" alt="Focused Create patch output card on desktop">
</picture>
...
<picture>
  ...
  <img src="../screenshots/bundle-output-desktop-light.webp" width="2242" height="796" style="height: auto" loading="eager" decoding="sync" alt="Focused patch-only bundle options and Create ZIP Bundle action on desktop">
</picture>

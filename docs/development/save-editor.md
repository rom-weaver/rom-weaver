...
Each handler exposes only fields with a checked write path. Generation III supports quantities in occupied inventory slots. Pokémon data and inventory structure changes remain unsupported.

...
You need an internet connection to download the practice files. [Sample asset generation](../development/development.md#generated-files) documents how a development checkout supplies the same files.

...
- `--database PACK` searches a local RWFP1 or RWFP2 pack instead of the built-in data and the installed packs. Repeatable.
...
- `quality`: `exact`, `partial`, or `metadata_only`, for a set-aware (RWFP2) match.

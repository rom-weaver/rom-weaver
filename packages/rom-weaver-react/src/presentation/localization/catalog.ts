...
const ENGLISH_MESSAGES = {
  ...
  "candidate.selectable": "Selectable {role} candidates:",
  ...
  "error.NO_SELECTABLE_CANDIDATE": "No selectable file candidate was found.",
  ...
  "error.SELECTION_NOT_FOUND": "The selected file candidate was not found.",

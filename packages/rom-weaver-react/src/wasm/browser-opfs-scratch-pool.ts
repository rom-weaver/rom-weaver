...
import { BrowserMemoryRandomAccessFile, BrowserOpfsRandomAccessFile } from "./browser-opfs-io-adapters.ts";
...
export async function createScratchFilePool({
  ...
  const scratchDirectoryHandle = (await directoryHandle.getDirectoryHandle(SCRATCH_DIRECTORY_NAME, {
    create: true,

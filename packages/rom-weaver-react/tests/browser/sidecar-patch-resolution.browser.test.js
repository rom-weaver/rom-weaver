...
test("sidecar resolver matches RetroArch patch basename and numeric order", () => {
  const entries = [
  ...
  expect(resolveSidecarPatchEntries("bundle/game.bin", entries).map((entry) => entry.fileName)).toEqual([
    "bundle/game.ips",

...
for (const url of [
  ...
  "https://rom-weaver.com/docs/install",
  "https://rom-weaver.com/docs/cli-get-started",
  "https://rom-weaver.com/docs/compression-formats",
  "https://rom-weaver.com/docs/supported-formats",

...
import { mtimeMs, newestMtime, PACKAGE_DIR, run, WASM_ARTIFACT, WASM_PACKAGE_DIR } from "./build-utils.mjs";
...
const WEB_ROOTS = [path.join(PACKAGE_DIR, "src"), path.join(WASM_PACKAGE_DIR, "src")];
const WEB_FILES = [

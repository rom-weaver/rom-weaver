...
/**
 * The fallback textarea MUST be inside the active modal dialog so it remains selectable while the page is inert.
 */
...
/**
 * When the document is unfocused, try synchronous copying during the user gesture instead of awaiting an async rejection.
 */

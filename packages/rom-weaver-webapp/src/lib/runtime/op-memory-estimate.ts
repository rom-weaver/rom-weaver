...
// The device-memory ceiling helpers now live in @rom-weaver/wasm (they size the wasm runtime, not
// commands); re-export them so existing callers keep resolving both halves through one import.
export { resolveAppleMobileSharedMemoryMaximumPages, resolveMemoryCeilingBytes } from "@rom-weaver/wasm";

...
const BRAND_MARK_TIGHT_VIEWBOX = "8 8 48 48";
// The square viewport leaves 5% on each side of the 48-unit mark.
const BRAND_MARK_FAVICON_VIEWBOX = "5.3333 5.3333 53.3333 53.3333";

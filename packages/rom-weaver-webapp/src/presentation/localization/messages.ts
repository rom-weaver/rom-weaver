...
const MESSAGES: Record<MessageId, MessageDescriptor> = {
  ...
  "ui.patchInputs.auto": msg({ id: "ui.patchInputs.auto", message: "Detect automatically" }),
  "ui.patchInputs.help": msg({
    id: "ui.patchInputs.help",
    message: "Choose the ROM state each enabled patch reads. Checksums still prove the ROM.",
  }),
  "ui.patchInputs.inherit": msg({ id: "ui.patchInputs.inherit", message: "Use shared rule" }),
  "ui.patchInputs.legend": msg({ id: "ui.patchInputs.legend", message: "Patch inputs" }),
  "ui.patchInputs.mapLabel": msg({ id: "ui.patchInputs.mapLabel", message: "Patch input thread map" }),
  "ui.patchInputs.original": msg({ id: "ui.patchInputs.original", message: "Original ROM" }),
  "ui.patchInputs.override": msg({ id: "ui.patchInputs.override", message: "Override input" }),
  "ui.patchInputs.overrideLabel": msg({ id: "ui.patchInputs.overrideLabel", message: "Override input for patch {n}" }),

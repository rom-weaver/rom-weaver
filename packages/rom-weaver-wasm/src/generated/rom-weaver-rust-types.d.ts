...
export type ChecksumCommand = { source: string, algo: Array<string>, select?: Array<string>, rom_filter?: boolean, patch_filter?: boolean, no_extract?: boolean, no_ignore?: boolean, strip_header?: boolean, no_trim_fix?: boolean, start?: bigint, length?: bigint, threads?: ThreadBudget, };
